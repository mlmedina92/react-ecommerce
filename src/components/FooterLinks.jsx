        ...
        <div className="row">
          <div className="d-none d-sm-block col-12 col-md-3">
            <NavLink className="text-decoration-none" to="/">
              <img src={logo} alt="Ecomerce" width="200" height="200" />
            </NavLink>
          </div>
          ...
          <div className="col-12 col-md-3 mb-3">
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                ...
                >
                  <i className="bi bi-telephone-fill"></i>
                  <strong> Ventas.</strong> Llamada : 2494460909
                </a>
              </li>
              <li className="mb-2">
                <a
                ...
                >
                  ...
                  <strong> Ventas.</strong> WhatsApp 2494328146
                </a>
              </li>
              <li className="mb-2">
                <a
