// ItemCoubt: sabe cual es el nro (si sube o baja). Cdo  damos clik al boton agregar al carrito ese valor se pasa al comp padre para que haga la logica de agregar al carrito. 
// Para cambiar el numero necesitamos que este persista: usamos el hook UseState con la variable count.
//cdo hago clik en boton + o - se ejecuta una funcion que modifica el count que es un estado -> provocamos una re renderizacion y el count ya no diria el valor inicial 1 por ej sino 2 si toque el boton +.
  ...
  return (
    <div className="p-0 text-center">
      <div className="row counter">
        ...
        {/* Clik en agregar al carrito: ejecucta func anonima, llamo a otra funcion q es onAdd pero le paso como argumento el valor del count(que seria quantity en la declaracion de la funcion ) por ej 4.  onAdd esta declarada en el padre ItemDetail y recien ahi la ejecuta - cuando hagan click en agregar el carrito lo unico q hace es pasarle al padre el valor*/}
        <button
          disabled={stock <= 0}
          onClick={() => onAdd(count)}
