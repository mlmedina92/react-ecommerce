...
//CONTEXT: nos sirve para guardar datos y comunicarlos entre componentes q no tienen pq ser padres e hijos. Si por ej el itemListContainer necesita pasarle datos al item, tenemos q pasar por prop al itemlist , el cual no los va a usar y va a pasarlo por prop al item, ese pasaje no es necesario creando contextos. Context es un objeto.
//el carrito es una buena opción para un contexto pq es algo q vamos a necesitar en muchos componentes y no seria buena practica hacer un pasamano de props por todos lados. Al carrito lo necesitamos en el comp cart, itemdetailcontainer pq es donde vamos a dar clik para agregar al carrito .
